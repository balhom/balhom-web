export default {
  ...
  auth: {
    ...
    verificationSent: 'Verificación enviada a {{email}}',
  ...
  income: {
    ...
    deleteConfirmMessage: '¿Estás seguro de que quieres eliminar "{title}"? Esta acción no se puede deshacer.',
    deleteIncome: 'Eliminar ingreso',
  },
  settings: {
    account: 'Configuración de la cuenta',
    accountDescription: 'Administra la configuración y preferencias de tu cuenta',
    email: 'Correo electrónico',
    ...
    deleteAccountDescription: 'Elimina permanentemente tu cuenta y todos los datos asociados',
    deleteAccountButton: 'Eliminar cuenta',
    currencyProfile: 'Perfil de Moneda',
    currencyProfileDescription: 'Administra la configuración de tu perfil de moneda',
    profileName: 'Nombre del Perfil',
    currency: 'Moneda',
    monthlySavingsGoal: 'Meta de Ahorro Mensual',
    yearlySavingsGoal: 'Meta de Ahorro Anual',
    sharedUsers: 'Usuarios Compartidos',
    sharedUsersDescription: 'Administra los usuarios que tienen acceso a este perfil',
